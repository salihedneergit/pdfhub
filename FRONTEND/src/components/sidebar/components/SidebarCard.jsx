const DisabilityLearningUpgradeCard = () => {
  return (
 <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#4ECDC4] via-[#45B7D1] to-[#2AB673] pb-4">
 <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-gradient-to-b from-[#4ECDC4] to-[#2AB673] dark:!border-navy-800">
 <svg
 width="41"
 height="41"
 viewBox="0 0 41 41"
 ...
 <p className="mt-1 px-4 text-center text-sm text-white">
  Enhance your learning experience with advanced accessibility features, 
  personalized support, and comprehensive resources.
 </p>
 <a
 target="blank"
 ...
 href="#upgrade-learning"
 >
  Upgrade Learning Plan
 </a>
 </div>
 </div>
  );
 };
 export default DisabilityLearningUpgradeCard;